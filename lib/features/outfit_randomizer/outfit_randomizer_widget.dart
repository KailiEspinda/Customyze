...
import 'outfit_randomizer_model.dart';
export 'outfit_randomizer_model.dart';

class OutfitRandomizerWidget extends StatefulWidget {
  const OutfitRandomizerWidget({super.key});

  static String routeName = 'OutfitRandomizer';
  static String routePath = '/OutfitRandomizer';

  @override
  State<OutfitRandomizerWidget> createState() => _OutfitRandomizerWidgetState();
}

class _OutfitRandomizerWidgetState extends State<OutfitRandomizerWidget> {
  late OutfitRandomizerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OutfitRandomizerModel());
